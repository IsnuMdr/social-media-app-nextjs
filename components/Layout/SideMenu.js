...
function SideMenu({
  ...
  return (
    <>
      ...
      >
        <Link href="/">
          <List.Item active={isActive("/")} as="a">
        ...
        <Link href="/messages">
          <List.Item active={isActive("/messages")} as="a">
            <Icon
        ...
        <Link href="/notifications">
          <List.Item active={isActive("/notifications")} as="a">
            <Icon
        ...
        <Link href={`/${username}`}>
          <List.Item active={router.query.username === username} as="a">
            <Icon
              name="user"
              size="large"
